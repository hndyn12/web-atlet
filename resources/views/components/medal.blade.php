...
<section class="py-16 bg-white">
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-12">
            <div class="flex flex-col items-center bg-yellow-50 rounded-2xl shadow-lg p-10 hover:shadow-2xl transition">
            ...
            <div class="flex flex-col items-center bg-gray-100 rounded-2xl shadow-lg p-10 hover:shadow-2xl transition">
            ...
            <div class="flex flex-col items-center bg-orange-50 rounded-2xl shadow-lg p-10 hover:shadow-2xl transition">
