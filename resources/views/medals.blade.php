<x-layout>
    ...
    <section id="medals" class="py-10 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-800 mb-4">Daftar Prestasi - Medali {{ ucfirst($medal) }}</h2>
                <div class="w-20 h-1 bg-red-400 mx-auto"></div>
            </div>
            <div id="medals" class="py-12 bg-white">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    @if ($achievements->isEmpty())
                        <div class="flex justify-center items-center h-40">
                            <p class="text-gray-500 text-center">Belum ada prestasi dengan medali {{ ucfirst($medal) }}.
                            </p>
                        </div>
                    @else
